...
static HB_PP_TOKEN s_dr079[ 1 ] = {
   { NULL       , NULL       , "2004201301",        10, 0, 0xc02a, 0 }
};
...
static HB_PP_TOKEN s_dr081[ 1 ] = {
   { NULL       , NULL       , "e8cc50254a83714ccb22e78db84a492a419aa576",  40, 0, 0xc029, 0 }
};
static HB_PP_TOKEN s_dm082[ 1 ] = {
   { NULL       , NULL       , "HB_VER_LENTRY",     13, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr082[ 1 ] = {
   { NULL       , NULL       , "2020-04-20 15:01 UTC+0200 Przemyslaw Czerpak (druzus/at/poczta.onet.pl)",  71, 0, 0xc029, 0 }
};
